...
calories, calories_abs, calories_from_energy, calories_abs_from_energy = process_keypoints(VIDEO_NAME, video, DISTANCE_ELBOW_WRIST, MASS_WEIGHT, MASS_FOREARM, RADIUS_BICEP, HEIGHT_SHOULDER, keypoints)
video.close()
